...
<div id="nav">
        ...
        <div class="container">
            ...
            <ul class="nav-menu">
                ...
                {{--<li class="has-dropdown megamenu">--}}
                    ...
                    {{--</div>--}}
                {{--</li>--}}
                @foreach($allCategories->slice(0,4) as $category)
                    <li><a href="/category/{{$category->slug}}">{{$category->name}}</a></li>
                @endforeach
                <li class="has-dropdown">
                    <a href="#">Все категории<i class="fas fa-caret-down" style="margin-left: 5px"></i></a>

                    <div class="dropdown">
                        <div class="dropdown-body">
                            <ul class="dropdown-list">
                                @foreach($allCategories->slice(4) as $category)
                                    <li><a href="/category/{{$category->slug}}">{{$category->name}}</a></li>
                                    @endforeach
                            </ul>
                        </div>
    ...
    <div id="nav-aside">
        <ul class="nav-aside-menu">
            <li><a href="{{route('index')}}">Главная</a></li>
            <li class="has-dropdown"><a>Категории <i class="fas fa-caret-down" style="float: right;"></i></a>
                <ul class="dropdown">
